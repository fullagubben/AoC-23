...
def comparemachine(gamenr,red,green,blue):
    if games[gamenr].red > red or games[gamenr].green > green or games[gamenr].blue > blue:
        return 0
    else:
        return gamenr+1
...
if __name__ == "__main__":
    ...
    for game in games:
        sumlist.append(comparemachine(games.index(game),red,green,blue))
